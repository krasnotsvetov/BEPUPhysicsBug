...
namespace BEPUphysicsDemos.AlternateMovement
{
    ...
    public class CharacterControllerInput
    {
        ...
        /// </summary>
        public CharacterCameraControlScheme CameraControlScheme { get; protected set; }
        ...
        public virtual void Update(float dt, KeyboardState previousKeyboardInput, KeyboardState keyboardInput, GamePadState previousGamePadInput, GamePadState gamePadInput)
        {
            if (IsActive)
            {
